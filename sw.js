const CACHE_NAME = "tpw-shell-v26";
const APP_SHELL = [
  "/",
  "/index.html",
  "/styles.css?v=17",
...
self.addEventListener("push", (event) => {
  ...
  event.waitUntil(self.registration.showNotification(data.title || "Tunisie Power Watch", {
    body: data.body || "Nouvelle information dans votre zone.",
    icon: "/assets/tn-power-watch.png",
    badge: "/assets/tn-power-watch.png",
    tag: data.zoneId ? `tpw-${data.zoneId}` : "tpw-update",
    data: { url: data.url || "/" },
  }));
});
